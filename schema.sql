...
create table userXoffer (
    userXoffer_id int not null auto_increment,
    user_id int not null,
    offer_id int not null,
    constraint PK_userXoffer primary key (userXoffer_id),
    constraint FK_userXoffer_user foreign key (user_id) references users (user_id),
    constraint FK_userXoffer_offer foreign key (offer_id) references offers (offer_id)
);